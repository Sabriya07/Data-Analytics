...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\JAREENA\Desktop\Loan_Data\sem4 report\DA\zomato_dataset.csv", encoding='latin1')
...
def show_insights_page():
    ...
    with tab1:
        ...
        # Rating Distribution
        sns.histplot(df['numeric_rate'], bins=20, kde=True, ax=axes[0], color='skyblue')
        axes[0].set_title("Rating Distribution")
        axes[0].set_xlabel("Rating (0-5)")
        
        # Cost Distribution
        sns.histplot(df['approx_cost'], bins=20, kde=True, ax=axes[1], color='salmon')
        ...
        sns.histplot(df[dist_col], bins=20, kde=True, color='purple')
    ...
    with tab4:
        ...
        # Clustering Results
        st.write("### Restaurant Segments (K-Means Clustering)")
